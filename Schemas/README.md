...
The versioned artifact bytes become immutable when 0.4.0 is published. Run `python Tools/update_release_bundle.py` after an authorized candidate edit and `--check` in CI.
