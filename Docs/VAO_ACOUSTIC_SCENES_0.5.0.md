# VAO spatial/acoustic implementation notes 0.5.0

This document is informative. The normative conformance contracts are the [Spatial profile](VAO_SPATIAL_PROFILE_0.5.0.md), [Acoustics profile](VAO_ACOUSTICS_PROFILE_0.5.0.md), main [standard](VAO_STANDARD_0.5.0.md), schemas, and conformance document.
