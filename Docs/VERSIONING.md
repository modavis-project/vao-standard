...
Candidates use repository labels/tags such as `0.4.0-rc.2` and remain unpublished drafts until approval. A final release requires clean conformance, immutable artifact digests, citation/license review, registry drafts, owner authorization, and a signed/tagged release according to the release checklist.
